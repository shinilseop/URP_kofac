...
public class BluetoothLeService extends Service {
    private final static String TAG = com.example.kket_led_control_yunji.BluetoothLeService.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        com.example.kket_led_control_yunji.BluetoothLeService getService() {
            return com.example.kket_led_control_yunji.BluetoothLeService.this;
        }
    }
